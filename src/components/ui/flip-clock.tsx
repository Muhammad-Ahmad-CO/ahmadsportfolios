...
export default function FlipClock({
  ...
  return (
    <button
      ...
      className="flex items-center gap-[3px] rounded-xl border border-white/[0.06] bg-[#0C0C0C]/50 px-2 py-1 backdrop-blur-md transition-colors hover:bg-white/[0.06] sm:gap-1 sm:px-2.5 sm:py-1.5">
