      ...
      <div className="mt-20 sm:mt-8 md:-mt-5 px-4">
        <FadeIn y={40} delay={0.15}>
          ...
          <div className="mx-auto w-full max-w-[1400px]">
            <ParticleText text="HI, I'M" className="h-[13vw] max-h-[130px] w-full" cursorRadius={45} />
            <ParticleText text="MUHAMMAD AHMED" className="h-[16vw] max-h-[190px] w-full" cursorRadius={55} />
          </div>
        </FadeIn>
      </div>
